	...
	<table width="520" border="0" cellspacing="0" cellpadding="0" align="center">
	          ...
	          <tr>
	            ...
	            <table width="90%" style="vertical-align:top;"><tr><td>
	                 <div class="ts">
	                 	<img src="<%=basePath%>images/error/P_ico2.gif" width="11" height="11" />
	               		出错信息提示!
	                 </div>
	                ...
	                <div class="info" style="color: red;">
	                	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;用户登录或密码不对,请重试或者向管理员联系
	                	<!-- 
	                	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="login/forgotPassword.jsp">找回密码>></a>
	                	 -->
	                </div>
	                <div class="link"><a href="login/logout.jsp">&lt;&lt;&nbsp;返回上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a id="" href="index.jsp" target="_top">&lt;&lt;&nbsp;返回首页</a></div>                
	            </td>
	            <td>

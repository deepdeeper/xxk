...
<link href='<%=basePath%>css/fullCalendar/fullcalendar.css' rel='stylesheet' />
<link href='<%=basePath%>cssfullCalendar/fullcalendar.print.css' rel='stylesheet' media='print' />

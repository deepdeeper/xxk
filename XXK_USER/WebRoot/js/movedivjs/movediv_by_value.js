var saveLeft,saveTop,saveWidth,saveHeight;
	...
	function setChild(div,div1,prompt)
	{
       var isMove = document.getElementById("isMove").checked;
		...
		topDiv.innerHTML = "<span style='top: 5px; left:5px; font-size: 12px; font-weight: bold; color: #102548; position: relative;' onselectstart='return false'>"+prompt+"</span>";
